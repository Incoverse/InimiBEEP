...
export default class SpotifyPauseCMD extends IBEEPCommand {
    ...
    public async exec(message: Message): Promise<any> {
        if (conditionUtils.meetsPermission(message, orHigher(TwitchPermissions.Moderator))) {
            ...
            await global.spotify.playback.pause();
            return this.sender.sendMessage(`Playback paused.`, message.message_id);
        }
    }
