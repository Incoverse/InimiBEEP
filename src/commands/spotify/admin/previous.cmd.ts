...
export default class SpotifySkipCMD extends IBEEPCommand {
    ...
    public async exec(message: Message): Promise<any> {
        if (conditionUtils.meetsPermission(message, orHigher(TwitchPermissions.Moderator))) {
            ...
            await global.spotify.playback.previous();
            return this.sender.sendMessage(`Skipped to previous track.`, message.message_id);
        }
    }
