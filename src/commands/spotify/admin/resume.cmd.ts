...
export default class SpotifyResumeCMD extends IBEEPCommand {
    ...
    public async exec(message: Message): Promise<any> {
        if (conditionUtils.meetsPermission(message, orHigher(TwitchPermissions.Moderator))) {
            ...
            await global.spotify.playback.resume();
            return this.sender.sendMessage(`Playback resumed.`, message.message_id);
        }
    }
